...
<body>
    ...
    <div class="page page-break">
        ...
        <div class="content-body" style="padding-top: 2rem;">
            ...
            <div style="background: #f0fdf4; border: 1px solid #16a34a; border-radius: 6px; padding: 1.25rem; margin-bottom: 2rem; display: flex; align-items: center; gap: 1rem;">
                <div style="background: #16a34a; color: white; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1.25rem;">!</div>
                <div>
                    <strong style="color: #166534; font-size: 1rem; display: block; margin-bottom: 0.25rem;">Payment Terms: Deposit Required</strong>
                    <p style="margin:0; color: #166534; font-size: 0.95rem;">A mandatory deposit of <strong>30,000 KES</strong> is required to initiate the engagement and secure the assessment timeline.</p>
                </div>
            </div>

            <div style="background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 6px; padding: 1.25rem; margin-bottom: 2rem;">
                <strong style="color: #0f172a; font-size: 1rem; display: block; margin-bottom: 0.75rem;">&#128179; Payment Methods</strong>
                <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem;">
                    <tr style="border-bottom: 1px solid #e2e8f0;">
                        <td style="padding: 0.5rem 0; color: #64748b; width: 40%;">Account Name</td>
                        <td style="padding: 0.5rem 0; font-weight: 600; color: #0f172a;">Arlington Studios</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #e2e8f0;">
                        <td style="padding: 0.5rem 0; color: #64748b;">Bank Account No.</td>
                        <td style="padding: 0.5rem 0; font-weight: 600; color: #0f172a; letter-spacing: 0.05em;">1339162997</td>
                    </tr>
                    <tr>
                        <td style="padding: 0.5rem 0; color: #64748b;">M-Pesa Till Number</td>
                        <td style="padding: 0.5rem 0; font-weight: 600; color: #16a34a; letter-spacing: 0.05em;">7003708</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="terms">
                ...
                <p style="margin:0;">1. <strong>Payment:</strong> A deposit of 30,000 will be paid before commencement of work; balance due Net-15 upon final report.<br>
