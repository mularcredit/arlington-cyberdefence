    ...
    <div class="page page-break">
        ...
        <div class="content-body" style="padding-top: 2rem;">
            ...
            <div style="background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 6px; padding: 0.75rem 1rem; margin-bottom: 1rem;">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem; font-family: 'Courier New', Courier, monospace;">
                    <tr style="border-bottom: 1px solid #e2e8f0;">
                        <td style="padding: 0.3rem 0; color: #64748b; width: 40%;">Account Name</td>
                        <td style="padding: 0.3rem 0; font-weight: 700; color: #0f172a; letter-spacing: 1px;">ARLINGTON STUDIOS</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #e2e8f0;">
                        <td style="padding: 0.3rem 0; color: #64748b;">Bank Account No.</td>
                        <td style="padding: 0.3rem 0; font-weight: 700; color: #0f172a; letter-spacing: 2px;">1339162997</td>
                    </tr>
                    <tr>
                        <td style="padding: 0.3rem 0; color: #64748b;">M-Pesa Till Number</td>
                        <td style="padding: 0.3rem 0; font-weight: 700; color: #166534; letter-spacing: 2px;">7003708</td>
                    </tr>
                </table>
            </div>
